...
<div class="wrapper boxed-wrapper">
  <header class="main-header"> 
    ...
    <span class="logo-mini"><img src="backend/img/logo-n-blue.png" alt=""></span> 
    <!-- logo for regular state and mobile devices --> 
    <span class="logo-lg"><img src="backend/img/logo-blue.png" alt=""></span> </a> 
    ...
    <nav class="navbar blue-bg navbar-static-top"> 
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">          
          ...
          <li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="backend/img/img1.jpg" class="user-image" alt="User Image"> <span class="hidden-xs">Alexander Pierce</span> </a>
          </li>
        </ul>
      </div>
    </nav>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview"> <a href="#"> <i class="fa fa-user"></i> <span>User</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li><a href="apps-support-ticket.html">Klinik</a></li>
...
<script src="backend/plugins/morris/morris.js"></script>
<script src="backend/plugins/functions/morris-init.js"></script>
</body>
</html>
